...
public interface IUnrestrictApi
{
    /// <summary>
    ...
    Task<UnrestrictCheck> CheckAsync(String link, String? password = null, CancellationToken cancellationToken = default);
    ...
    Task<UnrestrictLink> LinkAsync(String link,
    ...
    Task<IList<String>> FolderAsync(String link, CancellationToken cancellationToken = default);
    ...
    Task<IList<String>> ContainerFileAsync(Byte[] fileContents, CancellationToken cancellationToken = default);
    ...
    /// </param>
    /// <returns>A list of URL's</returns>
    Task<IList<String>> ContainerLinkAsync(String link, CancellationToken cancellationToken = default);
}

public class UnrestrictApi : IUnrestrictApi
{
